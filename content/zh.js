...
export const consult = {
  meta: {
    title: '预约诊断咨询',
    description:
      '预约与DODO Learning的20分钟诊断咨询。我们确切了解您的孩子实际在哪里——而不是学校评语说的在哪里。无需承诺。',
  },
  ...
  hero: {
    ...
    subheading:
      '不是学校成绩单告诉您的在哪里。咨询时20分钟。全程由导师主导——而非销售通话。',
    badge:      '20分钟 · 无需承诺',
  },
  ...
  trust: {
    eyebrow: '预约前请了解',
    heading: '这是一个诊断式咨询，不是销售电话。',
    body:
      'DODO咨询由Navigator主持——也就是实际执行课程的同一批人。如果16周课程目前不适合您的孩子，他们会如实告知您。',
    points: [
      '由Navigator主持，而非销售代表',
      '咨询结束前确定Lexile水平',
  ...
  cta: {
    ...
    form: {
      ...
      successBody:   '请期待在一个工作日内收到回复，确认咨询时间。',
...
export const methodology = {
  meta: {
    ...
    description:
      ...
      '以Lexile测量和6+1特质写作框架为支撑。' +
      '16周内提升一个年级阅读水平背后的认知训练体系。',
  },

  hero: {
    eyebrow: '教学方法',
    heading: 'The Loop不是我们教授的框架，而是我们实际的做法。',
    subheading:
  ...
  steps: [
    {
      ...
      heading: '超出舒适区。有意为之。',
      body:
        '16周课程中指定的每一篇文本，都根据学生当前Lexile水平选定，' +
        '处于其Lexile水平或略高的层次。目的不是制造挫败，而是拉伸。' +
    ...
    },
    {
      ...
      body:
        '每节课包含与Navigator的实时苏格拉底式对话。学生表明立场并进行论证。' +
        'Navigator不实时纠正——而是引导。这个阶段的目标不是流利度，' +
        '而是用英语表达清晰的思想。这个区别至关重要。',
      proof: '每节课均有Navigator主导的实时讨论。',
    },
    {
      id:      'write',
      number:  '04',
  ...
  cta: {
    ...
    body:         '诊断咨询是我们确切了解孩子当前水平的地方——并展示The Loop对像您孩子这样的学生是什么样子的。',
    ctaPrimary:   '预约咨询',
...
export const compare = {
  ...
  intro: {
    ...
    body:    '私人补习解决具体知识漏洞。公文式教育（Kumon）通过重复练习建立程序性流利度。阅读类应用提供文本访问渠道。课外英语班培养会话自信心。每一种方式都能解决真实存在的问题，但没有一种能够构建双语学术表现所需的核心认知架构：能够阅读复杂文本、进行推理、论证立场并用英语精确表达——这正是DODO所构建的能力。',
  },
  ...
  alternatives: [
    {
      id:       'tutoring',
      label:    '私人补习',
      what:     '老师与孩子一对一工作，针对具体的作业、考试准备或学科知识漏洞进行辅导。',
      ...
      dodo:     'DODO不是补习，而是构建认知基础架构——阅读深度、分析推理和结构化写作——从源头预防补习所要解决的问题。',
    },
    {
      id:       'kumon',
      label:    '公文式教育（Kumon）',
      ...
      limit:    '公文式的阅读项目主要针对词汇识别和句子层面的理解，不具备训练分析性推理、论证写作或处理高密度学术文本的能力。完成公文式阅读课程的学生，学术英语水平往往仍低于年级标准。',
    ...
    },
    {
      ...
      limit:    '会话英语与学术英语是不同的认知任务。一个英语口语流利的孩子，在阅读复杂文本、写作结构性论证或分析陌生段落时，也可能完全依赖中文思维。集体课程往往缺乏移动学业表现所需的强度和测量指标。',
    ...
    },
    {
      ...
      limit:    'App提供内容，但无法提供指导。它不能判断学生在具体文本上的困难原因，不能示范熟练阅读者的思维过程，也无法对书面推理给予反馈。学生在应用上的成长受限于其自身的认知上限。',
      dodo:     'DODO提供App无法替代的东西：一位能诊断学生思维方式而非仅识别解码能力的Navigator。The Hangar补充实时课程的成果——而非替代它。',
    },
    {
      id:       'school',
      label:    '学校英语课程',
  ...
  decision: {
    ...
    rows: [
      { need: '针对具体作业或考试的专项辅导',                         answer: '私人补习是最合适的工具。' },
      { need: '建立每日阅读习惯和解码流利度',                         answer: '公文式或阅读类App能起到帮助。' },
      { need: '提升英语会话自信心',                                   answer: '课外英语班是合适的选择。' },
      { need: '建立双语基础上的英语学术阅读、推理与写作能力',          answer: '这正是DODO所构建的。' },
    ],
  },
