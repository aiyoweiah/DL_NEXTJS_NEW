...
export const program = {
  ...
  architecture: {
    ...
    body:
      ...
      '跨越多个周期，学生逐步进阶 ELA 的七个级别（Levels 1–7），Level 7 达到大学水准的学术英语。' +
...
export const compare = {
    ...
    s6: {
      ...
      points: [
        ...
        { label: '更好的问题 ——而非更快的答案', body: '在您的孩子回应之后，导师（Navigator）的第一个动作永远是一个后续问题，这些问题源于哈佛教育学院零点项目的Visible Thinking（可视化思维方法）——而不是一句评价。这是培养思考者与训练应答者之间的区别——一个长出能力，另一个长出等着被告知的习惯。' },
