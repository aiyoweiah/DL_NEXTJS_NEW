...
export const home = {
  ...
  proof: [
    ...
    { id: 'lexile',   number: '1',    unit: '个年级',       label: '每个 16 周周期的平均 Lexile 阅读水平增长' },
...
export const about = {
  ...
  navigators: {
    ...
    p3:
      '他们是读者。他们是思考者。我们的 ELA 课程导师（Navigator）都拥有世界排名前 50 的大学（牛津大学、多伦多大学、皇后大学、伦敦政治经济学院等）的学位，并具有文学或写作的专业背景。我们的都学启蒙导师，则是专攻语音、发音与流利度的幼儿教育专家。不同的专长，同样的承诺——把语言视为孩子理解一切的方式；并相信一个英语训练扎实的孩子，其心智将比任何考试成绩都更能带他们走得更远。',
    navigatorsLink:  '认识导师（Navigator）团队 →',
...
export const compare = {
    ...
    s6: {
      ...
      points: [
        { label: '纵向知识', body: '按次计费的家教每次见到您的孩子都是全新的。导师（Navigator）则承载完整的弧线——您孩子的Lexile基线、他们从第一周开始的6+1特质档案、三次课前那个仍然需要改进的具体句子。每位导师（Navigator）都拥有世界排名前50的大学（牛津大学、多伦多大学、皇后大学、伦敦政治经济学院等）的学位，并具有文学或写作的专业背景。这种背景会累积。它产生的洞察力无法在一对一的单次课程中被复制。' },
    ...
    s8: {
      ...
      voices: [
        { quote: '在此之前我上了三年的英语课外辅导。我能回答阅读理解问题，但我实际上无法告诉你那章意味着什么或者为什么重要。第一次我的导师（Navigator）要求我为自己的解读辩护时，我无话可说。十六周后，我能写出两页的论证。', grade: '七年级', city: '卡尔加里', weeks: '16 周的课程，已完成', detail: 'Lexile 590 → 780 · 6+1 思考: 1 → 4 · 6+1 结构: 2 → 4 · 入学前已参加两年课外辅导' },
        { quote: '在我父母尝试了两个ESL项目之后才来到DODO Learning。我的英语变得更流利了，但我仍然写不出一篇言之有物的文章。在这里，导师（Navigator）让我把同一段重写了六遍。每一次我都理解了一些我以前不理解的东西。这是一种不同层次的工作。', grade: '六年级', city: '温哥华', weeks: '16 周的课程，第14周', detail: 'Lexile 610 → 760（第14周）· 6+1 声音: 1 → 3 · 6+1 用词: 2 → 4 · 此前就读于两家ESL机构' },
      ],
    },
    s9: {
  ...
  steps: [
    ...
    },
    {
      ...
      body:
        ...
        '拥有世界排名前50的大学（牛津大学、多伦多大学、皇后大学、伦敦政治经济学院等）的学位，' +
        '也是英语母语者。' +
...
export const results = {
  ...
  methodology: {
    ...
    body:
      ...
      'Visible Thinking（可视化思维方法），由拥有世界排名前50大学学位的导师（Navigator）一对一交付。',
    cta:     '阅读完整方法论',
    ctaHref: '/methodology',
  },
...
export const navigators = {
    ...
    s4: {
      ...
      points: [
        { label: '资质',  body: "每位导师（Navigator）都拥有世界排名前50的大学（牛津大学、多伦多大学、皇后大学、伦敦政治经济学院等）的学位，并具有英国文学或写作的专业背景。他们是经过认证的Lexile评估从业者，并接受过6+1特质写作框架的培训。英语母语者，在北美学术背景下具有与双语孩子的纵向合作经验。" },
...
export const founder = {
  ...
  short:
    ...
    '法语考试，2019 年从康考迪亚大学商学院毕业，获商学学士学位。2020 年，她创立了 ' +
  ...
  long: [
    ...
    'DODO Learning 今天教的每一件事——为什么要读经典而不是分级简写本，为什么 The LCS' +
      ...
      '验证过的那条路。2020 年，她创办了 DODO，让后面的孩子不必再一个人重走一遍。至今已' +
