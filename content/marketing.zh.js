...
export const program = {
  ...
  session: {
    ...
    sessionPhase:   '阅读 · Red Tide · Lexile 740',
    h2:   '一个典型的周二是什么样子的。',
    h2zh: null,
    p1: '导师打开当天的文本：',
    q1: '“今天我们读 Red Tide 第四章。你现在的 Lexile 是 740，比上周高 8 个点。今天要重点掌握的词是 malevolent。先把这个词拆开来看。”',
    p2: '用五分钟讲 MCT Building Language 里的拉丁词根——mal- 表示“坏”，volens 表示“有意愿的”。Malevolent 不只是“邪恶”，而是“有意作恶”。回到文本，反派角色的选择立刻有了新的意味。',
    p3: '然后进入章节。一起批注、暂停、追问。每个场景结束，导师提问：作者刻意没告诉我们什么？当 malevolent 是你脑中的词，故事是否变了？',
    p4: '课程以展望下次结束：',
    q4: '“下周是表达阶段。你要论证这个反派究竟是 malevolent，还是只是 afraid。请从这一章带三处文本证据来。”',
...
export const about = {
  meta: {
    title:
      '什么是DODO Learning？面向全球家庭的认知级英语读写教育',
    description:
  ...
  hero: {
    ...
    sub:
      '专为全球家庭打造——这些家庭的孩子将在英语主导的学校、大学和职场中成为引领者。他们中的许多孩子把英语当作一门学科来学——能通过考试，听起来流利。但让他们论证一个观点、阅读密集的分析性散文、或写出有原创性的东西——语言就达到了极限。我们的创始人看到了这个差距，并建立了DODO来弥合它。目标是在认知层面达到英语精通。双语深度是达到这一目标后自然产生的结果。',
