...
export const about = {
  ...
  hero: {
    ...
    sub:
      '专为全球家庭打造——这些家庭的孩子将在英语主导的学校、大学和职场中成为引领者。他们中的许多孩子把英语当作一门学科来学——能通过考试，听起来流利。但让他们论证一个观点、阅读密集的分析性散文、或写出有原创性的东西——语言就达到了极限。DODO 的创始人 Janet Sui 看到了这个差距，并建立了 DODO 来弥合它。目标是在认知层面达到英语精通。双语深度是达到这一目标后自然产生的结果。',
