  ...
  sections: {
    ...
    zh: [
      ...
      },
      {
        ...
        variant: 'dark', bg: '#212830',
        items: [
          { question: '什么是 LCS 教学理念？', answer: 'LCS 教学理念是 DODO 的课程框架 — 文学精读、系统写作训练、表达。文学精读是阅读的宝库，语言由此输入：完整的未删节经典作品、英语背后的拉丁和希腊词根，以及对好文章如何构建的敏锐感知。系统写作训练是构建引擎：语法优先且快速掌握，然后从句到段再到文章。表达是我们独有的部分，也是书本无法交付的部分 — 口头辩护、苏格拉底式对话、换位思考。每一节课中，这三者作为一个序列运行：阅读 → 思考 → 表达 → 写作。' },
