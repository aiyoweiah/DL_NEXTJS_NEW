    ...
    zh: [
      {
        ...
        variant: 'light', bg: '#F5F5FF',
        items: [
          { question: '16周课程具体包含什么内容？', answer: '课程贯穿 The Loop的四个阶段——阅读 → 思考 → 表达 → 写作——共历经16个结构化周次。每节课包含与导师（Navigator）的实时教学、课程间隙的结构化练习，以及基于 Lexile（蓝思）和 6+1 特质写作框架的进度跟踪。您的孩子将接触与年级水平相符的内容，而非简化材料。' },
