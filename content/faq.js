      ...
      },
      {
        ...
        items: [
          ...
          { question: 'What is the payment structure?',
            ...
            answer: 'Two options. Lump sum at enrollment, or weekly payments. Weekly rates: **Flex 1 from $74/week**, **Flex 2 from $132/week**, **Core from $140/week**, **Summit from $177/week**. Flex 3 weekly rate varies by subject (typically from $47/week). Both lump-sum and weekly options are available for every tier. All rates are in CAD.' },
    ...
    zh: [
      {
        ...
        heading: 'ELA 课程的 16 周具体包含哪些内容。',
        variant: 'light', bg: '#F5F5FF',
        items: [
          { question: 'ELA 课程的 16 周具体包含什么内容？', answer: '课程贯穿 The Loop的四个阶段——阅读 → 思考 → 表达 → 写作——共历经16个结构化周次。每节课包含与导师（Navigator）的实时教学、课程间隙的结构化练习，以及基于 Lexile（蓝思）和 6+1 特质写作框架的进度跟踪。您的孩子将接触与年级水平相符的内容，而非简化材料。' },
          { question: '有多少节课，每节课多长时间？', answer: '五种组合，每个周期均为 16 周。**Summit（全境领航）** 每周三节文学课加一节写作课。**Core（稳健航行）** — 最常见的选择 — 每周两节文学课加一节写作课。**Flex 1（文学阅读自由航行）** 为两节或以上文学课；**Flex 2（大师写作自由航行）** 为两节写作课；**Flex 3（课业进阶自由航行）** 每周一节或以上课业进阶课程，可与其他任何组合搭配。文学课每节 25 分钟，写作课每节 50 分钟，按固定每周时间表进行。' },
      ...
      },
      {
        ...
        items: [
          ...
          { question: '导师的学术背景如何？', answer: '每位导师均持有世界排名前50大学（牛津大学、多伦多大学、皇后大学、伦敦政治经济学院等）的学位，专业背景为英语文学或写作。所有导师均为英语母语者，均获得 Lexile 评估认证，并接受过 6+1 特质写作框架培训。大多数人拥有多年在北美学术环境中教授双语学生的经验。' },
      ...
      },
      {
        ...
        items: [
          ...
          { question: '6+1 特质写作框架是什么？',
            searchText: '6+1 trait writing framework seven dimensions ideas organization voice word choice sentence fluency conventions presentation 5-point rubric methodology',
            answer: '6+1 特质框架从七个维度衡量写作：思考、结构、声音、用词、流畅、规范和呈现。每个特质在 5 分制量表上独立评分。DODO 在每个 16 周周期中重点关注“思考”、“结构”和“声音”三个维度。完整框架文档详见[教学方法](/methodology)页面。' },
      ...
      },
      {
        ...
        items: [
          ...
          { question: 'ELA 课程的费用是多少？',
            searchText: 'program cost fee 2250 1185 sixteen weeks full program literacy foundation 25 minute writing session navigator assessments progress reports personalization no hidden costs',
            answer: '五种课程组合，每个周期均为16周，均含全程个性化定制。**Summit（全境领航）—— $2,830**：每周 3 节文学课 + 1 节写作课。**Core（稳健航行）—— $2,250** *（最受欢迎）*：每周 2 节文学课 + 1 节写作课。**Flex 1（文学阅读自由航行）—— $1,185**：每周 2 节文学课——以阅读基础为先。**Flex 2（大师写作自由航行）—— $2,110**：每周 2 节写作课——专注写作训练。**Flex 3（课业进阶自由航行）—— 起价 $750**：每周 1 节课业进阶课程——走在课堂前面的学科支持；具体费用因科目而异。所有档位均含入学、中期、结课三次评估，四份进度报告，以及完整的课程录像档案。所有价格均为加元（CAD）。' },
          ...
          { question: '除课程费用外是否有其他费用？', answer: '没有。报名费涵盖整个 16 周周期的全部内容。您不需要另外购买书籍、软件授权或补充材料。如果孩子需要特殊安排——延长课程时长、翻译材料、辅助技术——这些均免费包含在内。' },
          { question: '付款方式有哪些？',
            searchText: 'payment structure options lump sum full payment upfront weekly 74 per week enrollment plan',
          ...
          { question: '16周结束后是否有续课选项？', answer: '有。完成完整的 16 周周期且 Lexile 有可量化增长的学生，可以报名“高阶循环（Advanced Loop）”——一个内容难度更高的延伸课程。详情将在第16周结课评估回顾时与您分享。' },
        ],
      },
      {
