> **ARCHIVED 2026-09-03, verbatim.** This is the successor handoff as it stood after the
> 2026-09-02 sessions - 100 KB of newest-first session history (2026-09-02 back to 2026-06-02).
> The live handoff is now a one-page pointer at `docs/SUCCESSOR_HANDOFF.md`. Deep operational
> detail that still matters (consult-form architecture + env vars, CJK pipeline corrections,
> video pipeline, PFP apply log) lives in the dated sections below.
