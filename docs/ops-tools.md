...
| `/ops/teacher-agreement` | Teacher Service Agreement | v1.4 | 4-page contractor agreement — welcome letter, Schedule A + Schedule B (sections 1–9), execution page with cursive DODO Learning signature and fillable Teacher AcroForm fields |
