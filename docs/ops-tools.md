...
|---|---|---|---|
| `/ops/assessment` | Student Baseline Assessment Report | v3.3.1 | 5-page report from a baseline evaluation — Lit/Lit, Speaking/Discussion, Craft/Writing pillars with Lexile + module recommendations |
