...
export function courseSchema() {
  return {
    ...
    name:        'The DODO 16-Week Program',
    description:
      'The DODO 16-Week Program is a live, Navigator-led English literacy program ' +
    ...
    offers: {
      ...
      description:   'Initial-cohort enrollment for the 16-week program. ' +
...
// of the 16-Week Program. Intentionally NOT Lexile-led — K–2 is pre-formal-
...
export function littleDodoCourseSchema() {
  return {
    ...
    description:
      ...
      'the DODO 16-Week Program. Shares the same Navigators and live model; formal ' +
      'Lexile measurement begins later, in the 16-Week Program.',
