  ...
  return (
    <div>
      <div className="flex justify-between mb-2">
        ...
        <span style={{ fontFamily: 'var(--font-latin)', fontSize: '12px', fontWeight: 500, letterSpacing: '0.08em', color: 'var(--text-accent-dark)' }}>AFTER</span>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          {traits.map((t) => (
            <div key={t.name} className="flex items-center gap-3">
              <div style={{ width: '112px', fontSize: '12px', fontWeight: 500, fontFamily: 'var(--font-latin)', color: 'var(--text-body-dark)', flexShrink: 0 }}>{t.name}</div>
              <div className="flex-1 flex items-center gap-2">
                ...
                <div className="flex-1 rounded-full overflow-hidden" style={{ height: '6px', backgroundColor: '#E8E8F0' }}>
                  <div className="h-full rounded-full" style={{ backgroundColor: 'var(--color-lavender-signal)', width: `${(t.exit/6)*100}%` }} />
                </div>
              </div>
  ...
  return (
    <div className="relative w-full max-w-sm mx-auto" style={{ aspectRatio: '1/1' }}>
      <svg viewBox="0 0 400 400" className="w-full h-full" fill="none"
        ...
        <text x="200" y="37"  textAnchor="middle" fill="#0E0E12" fontSize="12" fontWeight="700">READ</text>
        ...
        <text x="360" y="197" textAnchor="middle" fill="#0E0E12" fontSize="12" fontWeight="700">THINK</text>
        ...
        <text x="200" y="357" textAnchor="middle" fill="#0E0E12" fontSize="12" fontWeight="700">SPEAK</text>
        ...
        <text x="40"  y="197" textAnchor="middle" fill="#0E0E12" fontSize="12" fontWeight="700">WRITE</text>
        ...
        <text x="200" y="193" textAnchor="middle" fill="#0E0E12" fontSize="13" fontWeight="700" opacity="0.6">THE LOOP</text>
  ...
  return (
    <div className="rounded-lg" style={{
      ...
      <button id={`ab-${id}`} aria-expanded={open} aria-controls={`ap-${id}`} onClick={onToggle}
        ...
        style={{ fontFamily: 'var(--font-latin)', fontSize: '15px', fontWeight: 600, color: 'var(--text-inverse)',
        ...
        <div className="container-section">
          <div className="text-center mb-12">
            ...
            <h2 style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '32px',
              color: 'var(--text-inverse)', letterSpacing: '-0.02em', lineHeight: 1.3 }}>
        ...
        <div className="container-section">
          <div className="max-w-3xl mb-12">
            ...
            <h2 className="mb-3" style={{ fontFamily: 'var(--font-latin)', fontWeight: 700, fontSize: '32px',
              color: 'var(--text-body-dark)', maxWidth: '640px', letterSpacing: '-0.02em', lineHeight: 1.3 }}>
              Before we begin, we find out exactly where your child is.
            </h2>
            <p style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '17px', color: 'var(--text-heading)', maxWidth: '520px', lineHeight: 1.6 }}>
            ...
            {ENTRANCE_STEPS.map((item) => (
              <div key={item.step} className="bg-white rounded-lg p-6 relative z-10"
                ...
                <div style={{ borderTop: '1px solid rgba(183,181,254,0.20)', paddingTop: '16px' }}>
                  <p style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '14px', color: 'var(--text-body-dark)', lineHeight: 1.5 }}>{item.produces}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container-section">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="mb-8" style={{ fontFamily: 'var(--font-latin)', fontWeight: 700, fontSize: '32px',
              color: 'var(--text-inverse)', maxWidth: '600px', letterSpacing: '-0.02em', lineHeight: 1.3 }}>
            ...
            <blockquote className="mt-8 pl-5" style={{ borderLeft: '3px solid #b7b5fe' }}>
              <p className="italic mb-3" style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '18px', color: 'var(--text-inverse)', lineHeight: 1.6 }}>
              ...
              <cite style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '13px', color: 'var(--text-accent-dark)', fontStyle: 'normal' }}>DODO Learning</cite>
            </blockquote>
          </div>
        </div>
      </section>
        ...
        <div className="container-section">
          <div className="mb-12">
            ...
            <h2 style={{ fontFamily: 'var(--font-latin)', fontWeight: 700, fontSize: '32px',
              color: 'var(--text-body-dark)', letterSpacing: '-0.02em', lineHeight: 1.3 }}>
              Week 16. The numbers that show what the Loop produced.
            </h2>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            <div>
              <h3 className="mb-6" style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '18px', color: 'var(--text-body-dark)' }}>The Assessment</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px' }}>
                {EXIT_DETAILS.map((item) => (
                  <div key={item.label} style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <div style={{ fontFamily: 'var(--font-latin)', fontSize: '12px', fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-accent-dark)' }}>{item.label}</div>
                    <div style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '15px', color: 'var(--text-body-dark)', lineHeight: 1.7 }}>{item.value}</div>
                  </div>
                ))}
              </div>
          ...
          <div className="text-center">
            <p className="max-w-xl mx-auto" style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '18px', color: 'var(--text-body-dark)' }}>
        ...
        <div className="container-section">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="mb-12" style={{ fontFamily: 'var(--font-latin)', fontWeight: 700,
              fontSize: 'clamp(30px,4vw,34px)', color: 'var(--text-inverse)', maxWidth: '680px', lineHeight: 1.3, letterSpacing: '-0.02em' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginBottom: '32px' }}>
              {[
                ...
                <div key={b.heading}>
                  <h3 className="mb-2" style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '16px', color: 'var(--text-inverse)' }}>{b.heading}</h3>
            ...
            <div className="mt-8">
              <Link href="/lexile" className="hover:underline underline-offset-4"
                style={{ fontFamily: 'var(--font-latin)', fontWeight: 500, fontSize: '14px', color: 'var(--text-accent-dark)' }}>
      ...
      <section id="six-plus-one" className="px-6 py-24 md:py-28" style={{ backgroundColor: 'var(--color-whisper)' }}>
        <div className="container-section">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="mb-12" style={{ fontFamily: 'var(--font-latin)', fontWeight: 700,
              fontSize: 'clamp(30px,4vw,34px)', color: 'var(--text-body-dark)', maxWidth: '680px', lineHeight: 1.3, letterSpacing: '-0.02em' }}>
              What is the 6+1 Trait writing framework — and how does it score my child&rsquo;s writing?
            </h2>
            <div className="mb-8">
              <h3 className="mb-2" style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '16px', color: 'var(--text-body-dark)' }}>What it is</h3>
              <p style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '15px', color: 'var(--text-heading)', lineHeight: 1.7 }}>
            ...
            <div className="mb-8">
              <h3 className="mb-4" style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '16px', color: 'var(--text-body-dark)' }}>The 7 traits</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {SIX_TRAITS.map(({ name, def }, idx) => (
                  <div key={name} className={idx >= 5 ? 'md:col-span-2 md:max-w-md' : ''}>
                    <div style={{ fontFamily: 'var(--font-latin)', fontWeight: 700, fontSize: '14px', color: 'var(--text-body-dark)', marginBottom: '4px' }}>{name}</div>
                    <div style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '14px', color: 'var(--text-heading)', lineHeight: 1.6 }}>{def}</div>
                  </div>
                ))}
              </div>
            </div>
            <div className="mb-8">
              <h3 className="mb-2" style={{ fontFamily: 'var(--font-latin)', fontWeight: 600, fontSize: '16px', color: 'var(--text-body-dark)' }}>What movement looks like</h3>
              <p style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '15px', color: 'var(--text-heading)', lineHeight: 1.7 }}>
            ...
            {/* Trait bars widget */}
            <div className="mb-8 max-w-2xl rounded-lg p-6" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.05)', backgroundColor: 'var(--surface-raised)' }}>
              <div className="flex justify-between mb-4">
                ...
                <div style={{ fontFamily: 'var(--font-latin)', fontSize: '12px', fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-accent-dark)' }}>Exit</div>
              </div>
      ...
      <section className="px-6 py-24 md:py-28" style={{ backgroundColor: 'var(--color-deep-void)' }}>
        <div className="container-section">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="mb-12" style={{ fontFamily: 'var(--font-latin)', fontWeight: 700, fontSize: '28px', color: 'var(--text-inverse)', letterSpacing: '-0.02em' }}>
      ...
      <section className="px-6 py-24 md:py-28" style={{ backgroundColor: 'var(--color-whisper)' }}>
        <div className="container-section">
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="mb-12" style={{ fontFamily: 'var(--font-latin)', fontWeight: 700, fontSize: '28px', color: 'var(--text-body-dark)', letterSpacing: '-0.02em' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                {[
                  ...
                  <p key={i} style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '15px', color: 'var(--text-heading)', lineHeight: 1.7 }}>{text}</p>
                ))}
            ...
            <div className="flex flex-col items-center gap-3 max-w-md mx-auto">
              ...
              <Link href="/program" className="w-full inline-flex items-center justify-center rounded-lg transition-all hover:border-white"
                style={{ fontFamily: 'var(--font-latin)', fontWeight: 500, fontSize: '16px',
                  backgroundColor: 'transparent', color: 'var(--text-inverse)', border: '1.5px solid rgba(240,240,240,0.50)',
                  padding: '14px 32px', textDecoration: 'none' }}>
                See the Full Program
              </Link>
              <Link href="/lexile" className="mt-2 hover:underline underline-offset-4"
                style={{ fontFamily: 'var(--font-latin)', fontWeight: 400, fontSize: '14px', color: 'var(--text-accent-dark)' }}>
                Read the full Lexile explainer →
              </Link>
            </div>
          </div>
