...
//   tinted     boolean   — true: .section-tinted bg (#EAEAF8). Use to alternate
//                          surfaces between two adjacent light sections per the
//                          "Section spacing protocol" in system.md.
...
//   ariaLabelledBy string — forwarded as aria-labelledby on the section element
...
export default function SectionWrapper({
    ...
    // Resolve background class — hero > white > darker > dark > tinted > light
    let bgClass = 'section-light'
    if (tinted) bgClass = 'section-tinted'
    ...
    return (
      <Tag id={id} aria-labelledby={ariaLabelledBy} className={bgClass}>
