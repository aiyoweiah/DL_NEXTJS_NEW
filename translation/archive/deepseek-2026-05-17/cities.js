  ...
  'vancouver': {
    ...
    zh: {
      h1:
        '温哥华的华语家庭，如何培养英语思维者？',
      subheading:
        '一套结构化的16周方法，训练完整的认知循环——阅读、思考、表达、写作——以英语进行，以Lexile衡量，由Navigator主导。',
      context:
...
export const citiesUi = {
  ...
  zh: {
    ...
    charterBody:      '咨询仅需20分钟。接待您的是Navigator，不是销售。我们测量您孩子的Lexile水平，并展示The 16周课程对于和您孩子情况一样的学生意味着什么。',
    charterCta:       '预约咨询',
