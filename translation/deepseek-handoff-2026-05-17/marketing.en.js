...
//
// Consolidated EN source for all 9 marketing pages.
...
export const program = {
  ...
  architecture: {
    ...
    h2:      'How the work compounds: Loop → LCS → Levels.',
    h2zh:    null,
    body:
  ...
  growth: {
    ...
    lexile: {
      ...
      sub:   'The same measurement system used by schools across North America — so you can compare progress directly. Our students average a 187-point gain — 1.2 grade levels — over 16 weeks.',
  ...
  steps: [
    ...
    },
    {
      ...
      body:
        ...
        'the same rubric used in Canadian and US classrooms. Ideas, Organisation, Voice, Word Choice, ' +
